...
function OverviewPage() {
  ...
  return (
    <div className="flex flex-1 h-full overflow-hidden">
      <DocumentViewer title="Software as a Service (SaaS) Agreement">
        <SampleContractBody />
      </DocumentViewer>
      ...
      <aside className="w-[380px] flex-shrink-0 bg-surface-container-lowest border-l border-outline-variant/30 flex flex-col overflow-hidden shadow-[-4px_0_15px_-3px_rgba(0,0,0,0.02)]">
        <div className="p-4 border-b border-outline-variant/30 bg-surface/50 sticky top-0 z-10">
          <h2 className="text-headline-md text-on-surface mb-2 font-semibold">
            Analysis Overview
          </h2>
        ...
        <div className="flex-1 overflow-y-auto p-4 flex flex-col gap-6">
          <div className="grid grid-cols-2 gap-2">
            <ScoreCard label="Overall Risk" value={contract.summary.overallRiskScore} suffix="/100" tint="warn" />
            <ScoreCard label="AI Confidence" value={contract.summary.aiConfidence} suffix="%" tint="tertiary" />
          </div>
