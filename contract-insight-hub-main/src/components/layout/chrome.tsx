  ...
  return (
    <header className="fixed top-0 w-full z-50 flex justify-between items-center px-8 h-16 bg-surface/80 backdrop-blur-md border-b border-outline-variant">
      ...
      <div className="flex items-center gap-4 text-on-surface-variant">
        <button aria-label="settings" className="p-2 rounded-full hover:bg-surface-variant transition-colors">
          <Icon name="settings" />
        </button>
        <button aria-label="notifications" className="p-2 rounded-full hover:bg-surface-variant transition-colors relative">
